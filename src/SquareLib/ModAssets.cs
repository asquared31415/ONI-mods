...
namespace SquareLib
{
    public static class ModAssets
    {
        ...
        public static Texture2D LoadTexture(string name, string folder = null)
        {
            ...
            var directory = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), folder ?? "assets");
            ...
            {
                Debug.LogError($"Could not load texture at {folder ?? "assets"}/{texFile}.png");
